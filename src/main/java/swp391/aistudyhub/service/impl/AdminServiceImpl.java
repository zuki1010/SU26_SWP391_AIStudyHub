...
public class AdminServiceImpl implements AdminService {
    ...
    private AdminDocumentResponseDTO mapAdminDocument(Document document) {
        ...
        if (document.getUser() != null) {
            ...
            dto.setUserRole(document.getUser().getRole() != null ? document.getUser().getRole().name() : null);
        }
    ...
    private AdminChatResponseDTO mapAdminChat(ChatMessage chatMessage) {
        ...
        dto.setSenderType(chatMessage.getSenderType() != null ? chatMessage.getSenderType().name() : null);
    ...
    private AdminStorageResponseDTO mapAdminStorage(CloudStorage storage) {
        ...
        if (storage.getUser() != null) {
            ...
            dto.setUserRole(storage.getUser().getRole() != null ? storage.getUser().getRole().name() : null);
        }
